...
const utils_1 = __nccwpck_require__(8185);
/**
 * Commands
 *
 * Command Format:
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const command_1 = __nccwpck_require__(7821);
const file_command_1 = __nccwpck_require__(3724);
const utils_1 = __nccwpck_require__(8185);
const os = __importStar(__nccwpck_require__(2087));
...
var Zip = __nccwpck_require__(8726);

var _require = __nccwpck_require__(8110),
...
var ManifestXmlParser = __nccwpck_require__(5969);

var ResourceFinder = __nccwpck_require__(5476);
...
var ApkParser = __nccwpck_require__(3792);

var AarParser = __nccwpck_require__(1951);

var IpaParser = __nccwpck_require__(8167);

var supportFileTypes = ['ipa', 'apk', 'aar'];
...
var AppInfoParser = /*#__PURE__*/function () {
  ...
  function AppInfoParser(file) {
    ...
    switch (fileType) {
      ...
      case 'aar':
        this.parser = new AarParser(this.file);
        break;
    }
  }
...
var parsePlist = __nccwpck_require__(272).parse;

var parseBplist = __nccwpck_require__(747)/* .parseBuffer */ .yY;

var cgbiToPng = __nccwpck_require__(9107);
 ...
 */
var ByteBuffer = __nccwpck_require__(1327);
...
// From https://github.com/openstf/adbkit-apkreader
var BinaryXmlParser = __nccwpck_require__(309);

var TextXmlParser = __nccwpck_require__(8513);
...
var ManifestParser = /*#__PURE__*/function () {
  ...
  _createClass(ManifestParser, [{
    ...
    value: function parse() {
      ...
      var document = this.xmlParser.parse().manifest[0];
      ...
      if (this.isText) {
        ...
        var permissions = document['uses-permission'];

        if (!!permissions && permissions.length > 0) {
          manifest.usesPermissions = permissions.map(function (attr) {
            return {
              name: attr['attr']['android:name']
            };
          });
        } else {
...
var FastXmlParser = __nccwpck_require__(4798);

var he = __nccwpck_require__(5488);
...
var Unzip = __nccwpck_require__(7444);
...
var Zip = /*#__PURE__*/function () {
  function Zip(file) {
    ...
    if (isBrowser()) {
      ...
      this.file = __nccwpck_require__(5622).resolve(file);
    }
...
const bigInt = __nccwpck_require__(575);
const debug = false;
...
const UID = __webpack_unused_export__ = function(id) {
  this.UID = id;
};

const parseFile = __webpack_unused_export__ = function (fileNameOrBuffer, callback) {
  return new Promise(function (resolve, reject) {
...
const parseBuffer = exports.yY = function (buffer) {
  // check header
...
module.exports = (function() {
    ...
    var buffer = __nccwpck_require__(4293),
        ...
        Long = __nccwpck_require__(8478),
        memcpy = null; try { memcpy = __nccwpck_require__(9449); } catch (e) {}
...
(function() {
  ...
  streamToBuffer = __nccwpck_require__(9956);

  bufferpack = __nccwpck_require__(5728);

  streamifier = __nccwpck_require__(2504);

  zlib = __nccwpck_require__(8761);

  crc = __nccwpck_require__(4738);
...
module.exports = __nccwpck_require__(8604).default;
...
module.exports = __nccwpck_require__(9989).default;
...
module.exports = __nccwpck_require__(5031).default;
...
module.exports = __nccwpck_require__(1171).default;
...
module.exports = __nccwpck_require__(3713).default;
...
module.exports = __nccwpck_require__(9515).default;
...
module.exports = __nccwpck_require__(8751).default;
...
module.exports = __nccwpck_require__(7773).default;
...
module.exports = __nccwpck_require__(1429).default;
...
module.exports = __nccwpck_require__(4819).default;
...
module.exports = __nccwpck_require__(4767).default;
...
var _create_buffer = __nccwpck_require__(397);

var _create_buffer2 = _interopRequireDefault(_create_buffer);

var _define_crc = __nccwpck_require__(174);
...
module.exports = {
  crc1: __nccwpck_require__(743),
  crc8: __nccwpck_require__(8545),
  crc81wire: __nccwpck_require__(8367),
  crc16: __nccwpck_require__(641),
  crc16ccitt: __nccwpck_require__(9351),
  crc16modbus: __nccwpck_require__(1510),
  crc16xmodem: __nccwpck_require__(4484),
  crc16kermit: __nccwpck_require__(228),
  crc24: __nccwpck_require__(168),
  crc32: __nccwpck_require__(170),
  crcjam: __nccwpck_require__(6348)
};
...
const buildOptions = __nccwpck_require__(8445).buildOptions;
...
const x2j = __nccwpck_require__(4498);
const buildOptions = __nccwpck_require__(8445).buildOptions;
...
const util = __nccwpck_require__(8445);
...
const nodeToJson = __nccwpck_require__(1663);
const xmlToNodeobj = __nccwpck_require__(4498);
const x2xmlnode = __nccwpck_require__(4498);
const buildOptions = __nccwpck_require__(8445).buildOptions;
const validator = __nccwpck_require__(9742);
...
exports.convertTonimn = __nccwpck_require__(7898).convert2nimn;
exports.getTraversalObj = xmlToNodeobj.getTraversalObj;
exports.convertToJson = nodeToJson.convertToJson;
exports.convertToJsonString = __nccwpck_require__(2993).convertToJsonString;
exports.validate = validator.validate;
exports.j2xParser = __nccwpck_require__(3108);
...
const util = __nccwpck_require__(8445);
const buildOptions = __nccwpck_require__(8445).buildOptions;
const xmlNode = __nccwpck_require__(5820);
const regx =
...
var Pend = __nccwpck_require__(9326);
...
var yauzl = __nccwpck_require__(9119);
var utils = __nccwpck_require__(8278);
...
var parserFunctions = __nccwpck_require__(8822);
...
var builderFunctions = __nccwpck_require__(3620);
...
var base64 = __nccwpck_require__(2023);
var xmlbuilder = __nccwpck_require__(6966);
...
var DOMParser = __nccwpck_require__(558)/* .DOMParser */ .a;
...
module.exports = __nccwpck_require__(6691).buffer
...
(function() {
  ...
  XMLNode = __nccwpck_require__(4736);
...
(function() {
  ...
  isObject = __nccwpck_require__(1968).isObject;
...
(function() {
  ...
  XMLDTDAttList = __nccwpck_require__(6525);

  XMLDTDEntity = __nccwpck_require__(3678);

  XMLDTDElement = __nccwpck_require__(110);

  XMLDTDNotation = __nccwpck_require__(9358);
...
(function() {
  ...
  isPlainObject = __nccwpck_require__(1968).isPlainObject;

  XMLNode = __nccwpck_require__(4736);

  XMLStringifier = __nccwpck_require__(5338);

  XMLStringWriter = __nccwpck_require__(9024);
...
(function() {
  ...
  ref = __nccwpck_require__(1968), isObject = ref.isObject, isFunction = ref.isFunction, isPlainObject = ref.isPlainObject;

  XMLElement = __nccwpck_require__(1428);

  XMLCData = __nccwpck_require__(4812);

  XMLComment = __nccwpck_require__(5098);

  XMLRaw = __nccwpck_require__(759);

  XMLText = __nccwpck_require__(7329);

  XMLProcessingInstruction = __nccwpck_require__(574);

  XMLDeclaration = __nccwpck_require__(886);

  XMLDocType = __nccwpck_require__(608);
  ...
  XMLAttribute = __nccwpck_require__(9485);
...
(function() {
  ...
  ref = __nccwpck_require__(1968), isObject = ref.isObject, isFunction = ref.isFunction;
...
(function() {
  ...
  ref = __nccwpck_require__(1968), isObject = ref.isObject, isFunction = ref.isFunction, isEmpty = ref.isEmpty;
...
(function() {
  ...
  XMLWriterBase = __nccwpck_require__(7846);
...
(function() {
  ...
  ref = __nccwpck_require__(1968), assign = ref.assign, isFunction = ref.isFunction;

  XMLDocument = __nccwpck_require__(1139);

  XMLDocumentCB = __nccwpck_require__(4285);

  XMLStringWriter = __nccwpck_require__(9024);

  XMLStreamWriter = __nccwpck_require__(4088);
...
var htmlEntity = __nccwpck_require__(3793);
var sax = __nccwpck_require__(4138);
var XMLReader = sax.XMLReader;
var ParseError = sax.ParseError;
var DOMImplementation = /* unused reexport */ __nccwpck_require__(1355).DOMImplementation;
/* unused reexport */ __nccwpck_require__(1355) ;
exports.a = DOMParser;
...
var fd_slicer = __nccwpck_require__(5214);
var crc32 = __nccwpck_require__(6542);
var util = __nccwpck_require__(1669);
var EventEmitter = __nccwpck_require__(8614).EventEmitter;
...
(() => {
const core = __nccwpck_require__(8041);
const AppInfoParser = __nccwpck_require__(4355);
